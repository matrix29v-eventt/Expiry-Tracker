...
export default function Navbar() {
  ...
  const avatar = (
    <span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-tr from-blue-500 to-blue-300 text-white font-bold text-lg shadow border-2 border-white ml-3">
      {name ? name.charAt(0).toUpperCase() : "ET"}
    </span>
  );
              ...
              {!isLoggedIn ? (
                ...
                <>
                  ...
                  >
                    ...
                    {unreadCount > 0 && (
                      <span className="absolute -top-0.5 -right-0.5 min-w-5 h-5 px-1 flex items-center justify-center rounded-full bg-red-500 text-white text-xs font-bold">
